...
Mooweee is an online Movie Ticket Booking web app with MERN Stack.
...
### Tech
Mooweee uses a number of open source projects to work properly:
...
Mooweee requires [Node.js](https://nodejs.org/)  to run.
...
Mooweee is currently extended with the following plugins. Instructions on how to use them in your own application are linked below.
